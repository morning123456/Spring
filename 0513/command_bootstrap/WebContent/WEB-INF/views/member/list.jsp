   				...
   				<div id="keyword" class="card-tools" style="width:550px;">
					    ...
					    --%>
							...
							<c:set var="cri"  value="${pageMaker.getCri()}"/>
					  		<option value="10" ${cri.getPerPageNum() eq 10 ? "selected" : "" } >정렬개수</option>
					  		<option value="2" ${cri.getPerPageNum() eq 2 ? "selected" : "" } >2개씩</option>
					  		<option value="3" ${cri.getPerPageNum() eq 3 ? "selected" : "" } >3개씩</option>
					  		<option value="5" ${cri.getPerPageNum() eq 5 ? "selected" : "" } >5개씩</option>
