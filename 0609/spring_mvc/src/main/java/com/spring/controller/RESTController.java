...
public class RESTController {
	 ...
	 * 
	 * // 출력 ObjectMapper mapper = new ObjectMapper();
	 * 
	 * // content Type 결정 response.setContentType("application/json;charset=utf-8");
	 * PrintWriter out = response.getWriter();
	 * 
	 * // 내보내기 out.println(mapper.writeValueAsString(dataMap));
	 * 
	 * // out 객체를 종료하고 환원. out.close();
	 * 
	 * }
	 */
	...
	public ResponseEntity<Map<String, Object>> restSpringBest() {
		...
		try {
			...
			result = new ResponseEntity<Map<String, Object>>(dataMap, 
						HttpStatus.OK);
		} catch (Exception e) {
			result = new ResponseEntity<Map<String, Object>>(dataMap, 
